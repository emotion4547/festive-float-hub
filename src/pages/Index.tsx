...
const faqItems = [
  {
    ...
    answer: "Мы доставляем заказы по Краснодару в течение 2-4 часов.",
  },
  {
    question: "Сколько стоит доставка?",
    answer: "Стоимость доставки курьером по Краснодару от 300₽. При заказе от 5000₽ доставка бесплатная. Самовывоз бесплатный.",
  },
  {
